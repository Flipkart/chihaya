module github.com/Flipkart/chihaya

require (
	github.com/SermoDigital/jose v0.0.0-20161205224733-f6df55f235c2
	github.com/anacrolix/dht v0.0.0-20180711032309-5f03eb126491 // indirect
	github.com/anacrolix/torrent v0.0.0-20180727001856-81e6061a5347
